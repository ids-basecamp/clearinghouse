...
* **app:** Bump dependencies & Rust Edition 2024 (#131) ([ff6e3e8](https://github.com/ids-basecamp/clearinghouse/commit/ff6e3e8255406440be2629509aa5baafee638f4d))
* **app:** Multiple small changes ([39d0d7d](https://github.com/ids-basecamp/clearinghouse/commit/39d0d7da4f9897cc1e176216aa67cca12f86c698))
  * Changed default config value `clear_db`
  * Fixed default `ids:issued` timestamp to complex format
  * Added more details in log message and reduced logging of libraries in `TRACE` or `DEBUG` mode
  * Added build optimization for Docker build
